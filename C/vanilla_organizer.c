...
// Add category if keyword matches.
...
// Determine categories based on file name.
int get_categories(const char* filename, char categories[][512]) {
    ...
    check_and_add_category(lower_name, "masscan", "Scanner", categories, &num_categories);
    check_and_add_category(lower_name, "scan", "Scanner", categories, &num_categories);

    check_and_add_category(lower_name, "metasploit", "Exploitation", categories, &num_categories);
    check_and_add_category(lower_name, "exploit", "Exploitation", categories, &num_categories);
    check_and_add_category(lower_name, "vuln", "Exploitation", categories, &num_categories);

    check_and_add_category(lower_name, "burp", "Web_Tools", categories, &num_categories);
    check_and_add_category(lower_name, "web", "Web_Tools", categories, &num_categories);
    check_and_add_category(lower_name, "dirbuster", "Web_Tools", categories, &num_categories);

    check_and_add_category(lower_name, "hydra", "Password_Cracking", categories, &num_categories);
    check_and_add_category(lower_name, "john", "Password_Cracking", categories, &num_categories);
    check_and_add_category(lower_name, "hashcat", "Password_Cracking", categories, &num_categories);
    check_and_add_category(lower_name, "cracker", "Password_Cracking", categories, &num_categories);

    check_and_add_category(lower_name, "wireshark", "Sniffing", categories, &num_categories);
    check_and_add_category(lower_name, "tcpdump", "Sniffing", categories, &num_categories);
    check_and_add_category(lower_name, "sniff", "Sniffing", categories, &num_categories);
...
void organize_tools(const char* folder) {
    ...
    while ((entry = readdir(dir)) != NULL) {
        ...
        // Copy the tool into all applicable categories.
